package com.nadeem.hindustan.views.roundimage;
...
public class RoundedDrawable extends Drawable {
    ...
    public static Bitmap drawableToBitmap(Drawable drawable) {
        ...
        try {
            ...
            LogReport.e(TAG,e.getMessage(),e);
            LogReport.w(TAG, "Failed to create bitmap from drawable!");
            bitmap = null;
        }
